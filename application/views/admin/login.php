...
<section class="section-account">
    <div class="img-backdrop" style="background-image: url('<?= base_url()."assets/mat-admin" ?>/img/header.jpg')"></div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-6" style="text-align: center;">
                    <br/>
                    <span class="text-lg text-bold text-primary">PANDORAS BOX</span>
                    <br/><br/>
...
<script src="<?= base_url()."assets/mat-admin" ?>/js/core/demo/Demo.js"></script>
<!-- END JAVASCRIPT -->
