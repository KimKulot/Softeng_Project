    ...
    <section>
        ...
        <div class="section-body">
            <div class="card card-bordered style-primary">
                <div class="card-head">
                    <header><i class="fa fa-fw fa-tag"></i>New Secure Note</header>
                </div>
                <div class="card-body style-default-bright">
                    <form action="<?= base_url()."c_secures/addsecure" ?>" method="post">
                        ...
                        <div class="form-group floating-label">
                            <label for="folder">Folder</label>
                             <select type="text" class="form-control" id="folder" name="folder" required>
